...
class Window:
    ...
    def loop(self):
        while True:
            ...
            self.draw_text('Nakup', 20, 60, 75, self.red)
            self.draw_text('Prodej', 20, 60, 105, self.red)

            self.draw_text('Mena', 23, 60, 140, self.black)
            self.draw_text('EUR', 20, 60, 165, self.red)
            self.draw_text('GBP', 20, 60, 195, self.red)
            self.draw_text('USD', 20, 60, 225, self.red)
            self.draw_text('JPY', 20, 60, 255, self.red)
            self.draw_text('IDR', 20, 60, 285, self.red)

            self.draw_text('Kurz', 23, 60, 320, self.black)
            self.draw_text('nejaky cislo', 20, 60, 345, self.purple)
            self.draw_text('dalsi cislo', 20, 60, 375, self.purple)
